      ...
      <footer className="footer">
        <div className="footer-inner">
          ...
          <ul>
            ...
            <li><Link to="" className="footer-link">Safety & eco</Link></li>
            <li><Link to="" className="footer-link">About our ads</Link></li>
            <li><Link to="" className="footer-link">&copy; FindAbode 2020</Link></li>
          </ul>
        </div>
      </footer>
    )
